...
# source: steammessages_offline_steamclient.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'steammessages_offline_steamclient.proto'
)
