...
# source: steammessages_linkfilter_steamclient.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'steammessages_linkfilter_steamclient.proto'
)
